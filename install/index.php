...
function check_($check) {
    ...
    $file              = file_get_contents('http://api.doniaweb.com/mahmoud.json');
    if ($file) {
						...
						<div>
                            ...
                            <div class="setting-well">
                                ...
                                <div class="req">
									...
									<br>
									<p>If you have any question, please <a href="https://doniaweb.com" class="main">let us know</a>.</p>
                                    <br><br>
                                ...
                                <div class="req">
									...
									<form action="?page=installation" method="post" class="form-horizontal install-site-setting">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" name="purshase_code" value="<?php echo (!empty($_POST['purshase_code'])) ? trim($_POST['purshase_code']) : '';?>" placeholder="Purchase code: DoniaWeB" autofocus>
                                                <span class="help-block">Licensed by <a href="https://doniaweb.com" class="main">Donia WeB</a>.</span>
                                            </div>
											<div class="col-md-2"></div>
                                        </div>
                                        <div class="form-group">
